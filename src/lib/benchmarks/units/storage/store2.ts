...
export const storeJsBenchmark: BenchmarkUnit = {
    id: 'store2',
    name: 'store2',
    description: 'A feature-rich, cross-browser local storage wrapper. (Note: This is store2 by Nathan Bubna, a better-maintained alternative to the original store.js by Marcus Westin).',
    icon: '🏪',
