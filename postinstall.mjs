...
if (fs.existsSync(bzip2Index)) {
    ...
    const patched = "this.wasmModule = await loadBZip2WASM({ locateFile: () => '/wasm/bzip2.wasm' });";
    if (src.includes(original)) {
        ...
        console.warn('[postinstall] WARNING: bzip2-wasm/index.js unexpected format, skip patch.');
    }
}
